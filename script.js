...
fetch("https://restcountries.com/v3/all")
  ...
  const arr = code.split(",");
    ...
    if (i < data.length) {
        ...
        div.setAttribute("class", "card text-center text-black bg-danger");
    ...
    if (i < data.length) {
        ...
        col.style.padding="2%";
        var div = document.createElement("div");
        div.setAttribute("class", "card text-center text-black bg-warning");
        div.setAttribute("height", "40px");
        div.setAttribute("width", "30px");
        var div2 = document.createElement("div");
        div2.setAttribute("class", "card-header");
    ...
    if (i < data.length) {
        ...
        col.style.padding="2%";
        var div = document.createElement("div");
        div.setAttribute("class", "card text-center text-black bg-info");
        div.setAttribute("height", "40px");
        div.setAttribute("width", "30px");
        var div2 = document.createElement("div");
        div2.setAttribute("class", "card-header");
