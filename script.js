...
fetch("https://restcountries.com/v3/all")
  ...
  document.getElementById("country").append = html;
  }

  function getWeather(code) {
  const arr = code.split(",");
    var link = "https://api.openweathermap.org/data/2.5/weather?lat=" + arr[0] + "&lon=" + arr[1] + "&appid=68364d702adf8588f4e4e1ab3ff1db5a";
    ...
    .then(function (jsondata) {
      ...
      div5.setAttribute("class", "text-center");
        div5.innerHTML = "Condition: " + jsondata.weather[0].description + "<br>Speed of Wind: " + jsondata.wind.speed + "Kmph" + "<br>Temperature: " + jsondata.main.temp + "K";
      ...
      document.getElementById("country").appendChild(div1);
    ...
    cc.setAttribute("class", "row mt-5");
        ...
        if (i < data.length) {
            ...
            div.setAttribute("class", "card bg-danger text-center");
            ...
            text.innerHTML = "Capital: " + data[i].capital + "<br>Latlng: " + data[i].latlng + "<br>Region: " + data[i].region + "<br>Country code: " + data[i].cca2;
    ...
    if (i < data.length) {
        ...
        col.style.padding="2%";
        var div = document.createElement("div");
        div.setAttribute("class", "card bg-warning text-center");
        div.setAttribute("height", "40px");
        div.setAttribute("width", "30px");
        var div2 = document.createElement("div");
        div2.setAttribute("class", "card-header");
        ...
        var text = document.createElement("p");
        text.setAttribute("class", "card-text");
        text.innerHTML = "Capital: " + data[i].capital + "<br>Latlng: " + data[i].latlng + "<br>Region: " + data[i].region;
        text.style.padding="3%";
        div.appendChild(text);
        var button = document.createElement("button");
        button.setAttribute("type", "button");
    ...
    if (i < data.length) {
        ...
        col.style.padding="2%";
        var div = document.createElement("div");
        div.setAttribute("class", "card bg-info text-center");
        div.setAttribute("height", "40px");
        div.setAttribute("width", "30px");
        var div2 = document.createElement("div");
        div2.setAttribute("class", "card-header");
    ...
    document.getElementById("country").appendChild(cc);
  }
}
